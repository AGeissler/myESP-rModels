...
# actuates the air point in mb_recep.
    ...
    0   19   7.000  # ctl type, law (senses dry bulb temperature in reception.), start @
     13.  # No. of data items
  5000.000 0.000 5000.000 0.000 50.000 14.000 1.000 4.000 0.000 0.000 0.000 20.000 25.000
    0    2  18.000  # ctl type, law (free floating), start @
      0.  # No. of data items
* Control function    3
...
# actuates the air point in mb_conf.
   10    0    0  # actuator data
    ...
    0   19   7.000  # ctl type, law (senses dry bulb temperature in conference.), start @
     13.  # No. of data items
  5000.000 0.000 5000.000 0.000 50.000 14.000 1.000 3.000 0.000 0.000 0.000 20.000 25.000
    0    2  18.000  # ctl type, law (free floating), start @
      0.  # No. of data items
* Control function    4
...
# actuates the air point in ceiling_belo.
    ...
    0   11   0.000  # ctl type, law (senses dry bulb temperature in ceil_void.), start @
     12.  # No. of data items
  5000.000 0.000 5000.000 0.000 1.000 3.000 5.000 0.000 0.000 0.000 1.000 1.000
# Function:Zone links
 0,0,0,0,0,1,0,4,2,3
* Mass Flow
Flow controls based on multi-sensor user directives for HVAC. Facade vents set to closed.
  19  # No. of controls
* Control mass    1
...
# actuates flow connection:   2 BW-Op01:008 - manager via GrOpz01:008
   -3    2    0  # actuator data
    ...
    1  365  # valid Wed-01-Jan - Wed-31-Dec
     1  # No. of periods in day: weekday     
    1    0   0.000  # ctl type (dry bulb > flow), law (on/off setpoint 0.00 inverse action ON fraction 1.000.), starting @
      3.  # No. of data items
...
# actuates flow connection:  29 BW-Op03:024 - conference via GrOpz03:024
   -3   29    0  # actuator data
    ...
    1  365  # valid Wed-01-Jan - Wed-31-Dec
     1  # No. of periods in day: weekday     
    1    0   0.000  # ctl type (dry bulb > flow), law (on/off setpoint 0.00 inverse action ON fraction 0.000.), starting @
      3.  # No. of data items
